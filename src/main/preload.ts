...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    ensureDefaultCoverCachePath: () => ipcRenderer.invoke('app:ensureDefaultCoverCachePath'),
    ...
    immersiveBackground: {
        importBackground: (filePath: string, mediaType: string) => ipcRenderer.invoke('immersiveBackground:importBackground', filePath, mediaType),
        prepareVideo: (filePath: string, quality?: string) => ipcRenderer.invoke('immersiveBackground:prepareVideo', filePath, quality),
        listCachedVideos: () => ipcRenderer.invoke('immersiveBackground:listCachedVideos'),
        renameCachedVideo: (cachePath: string, displayName: string) => ipcRenderer.invoke('immersiveBackground:renameCachedVideo', cachePath, displayName),
        deleteCachedVideo: (cachePath: string) => ipcRenderer.invoke('immersiveBackground:deleteCachedVideo', cachePath),
    },
    ...
    library: {
        ...
        getPlaylistByExternalId: (externalId: string, source: string) => ipcRenderer.invoke('library:getPlaylistByExternalId', externalId, source),
        updatePlaylistMetadata: (playlistId: string, metadata: Record<string, unknown>) => ipcRenderer.invoke('library:updatePlaylistMetadata', playlistId, metadata),
        ...
        deleteTrackFile: (trackFileId: string) => ipcRenderer.invoke('library:deleteTrackFile', trackFileId),
