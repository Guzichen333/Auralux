...
(function (global) {
  ...
  var icons = {
    ...
    palette: function (s) { return stroke('<path d="M12 22a10 10 0 1 1 10-10c0 2.2-1.8 4-4 4h-1.5a1.5 1.5 0 0 0-1.1 2.5l.3.3A1.9 1.9 0 0 1 14.3 22H12z"/><circle cx="7.5" cy="10.5" r=".8" fill="currentColor" stroke="none"/><circle cx="10.5" cy="7.5" r=".8" fill="currentColor" stroke="none"/><circle cx="14" cy="7.5" r=".8" fill="currentColor" stroke="none"/><circle cx="16.5" cy="10.5" r=".8" fill="currentColor" stroke="none"/>', { size: s }); },
