...
interface ElectronAPI {
    ...
    immersiveBackground?: {
        importBackground: (filePath: string, mediaType: string) => Promise<{
            success: boolean
            sourcePath?: string
            cachePath?: string
            mediaType?: string
        ...
        prepareVideo: (filePath: string, quality?: string) => Promise<{
            success: boolean
            sourcePath?: string
            cachePath?: string
            reused?: boolean
        ...
        renameCachedVideo: (cachePath: string, displayName: string) => Promise<{
            success: boolean
            error?: string
        }>;
        deleteCachedVideo: (cachePath: string) => Promise<{
            success: boolean
            error?: string
        }>;
    }
