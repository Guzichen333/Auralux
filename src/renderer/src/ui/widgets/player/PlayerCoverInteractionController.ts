...
interface PlayerCoverInteractionControllerOptions {
    ...
    isMiniMode: () => boolean;
    onOpenLyrics: () => void;
    onOpenImmersivePlayer: () => boolean | void;
...
class PlayerCoverInteractionController {
    ...
    private readonly onOpenImmersivePlayer: () => boolean | void;
    ...
    constructor(options: PlayerCoverInteractionControllerOptions) {
        ...
        this.onOpenImmersivePlayer = options.onOpenImmersivePlayer;
        this.onToggleMiniMode = options.onToggleMiniMode;

        this.coverClickHandler = () => {
            if (this.onOpenImmersivePlayer()) return;
            this.onOpenLyrics();
        };
