...
class TrackList extends Component {
    ...
    createTrackItem(track: Track, index: number): HTMLElement {
        ...
        const isNetease = (track as any).source === 'netease' || (typeof track.filePath === 'string' && track.filePath.startsWith('netease://'));
        const sourceBadge = isNetease ? '<span class="track-source-badge track-source-netease">网易云</span>' : '';
        ...
        if (this.showCovers) {
            ...
            item.innerHTML = `
                ...
                <div class="track-info">
                    <div class="track-title">${sanitizeHTML(track.title || 'Unknown Title')}${sourceBadge}</div>
