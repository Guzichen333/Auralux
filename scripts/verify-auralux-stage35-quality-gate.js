...
const checks = [
  ...
  ['node', ['scripts/verify-auralux-visible-brand-copy.js']],
  ['node', ['scripts/verify-sonic-topography-player-theme.js']],
  ['node', ['scripts/verify-stage36-visible-copy-cleanup.js']],
  ['node', ['scripts/verify-settings-ui-chinese.js']],
  ['node', ['scripts/verify-settings-hidden-plugin-network-drive.js']],
  ...
  ['node', ['scripts/verify-startup-navigate-after-netease-api.js']],
  ['node', ['scripts/verify-startup-api-failure-manual-enter.js']],
  ['node', ['scripts/verify-startup-stage47.js']],
  ...
  ['node', ['scripts/verify-ui-next-add-to-queue.js']],
  ...
  ['node', ['scripts/verify-immersive-sonic-topography-background.js']],
  ['node', ['scripts/verify-netease-api-late-ready-recovery.js']],
  ['node', ['scripts/verify-netease-api-port-conflict-recovery.js']],
  ...
  ['node', ['scripts/verify-netease-asset-migration-bulk-library-write.js']],
  ['node', ['scripts/verify-netease-asset-migration.js']],
  ['node', ['scripts/verify-netease-migration-progress-lifecycle.js']],
  ['node', ['scripts/verify-netease-migration-progress-reentry.js']],
  ['node', ['scripts/verify-netease-migration-cancelled-dashboard.js']],
  ['node', ['scripts/verify-netease-migration-preflight-cancel-report.js']],
  ['node', ['scripts/verify-netease-migration-result-consistency.js']],
  ['node', ['scripts/verify-netease-limited-stream-playback-guards.js']],
  ['node', ['scripts/verify-netease-search-experience.js']],
  ['node', ['scripts/verify-netease-search-stage45.js']],
  ['node', ['scripts/verify-netease-trusted-sync.js']],
  ['node', ['scripts/verify-netease-trusted-sync-stage44.js']],
  ...
  ['node', ['scripts/verify-offline-cache-stage46.js']],
  ['node', ['scripts/verify-stage48-ui-next-legacy-boundary.js']],
